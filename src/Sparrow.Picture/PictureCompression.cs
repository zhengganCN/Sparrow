...
namespace Sparrow.Picture
{
    ...
    public class PictureCompression
    {
        ...
        /// <returns></returns>
        public Stream PicCompression(Stream imageStream, Size destSize, EncoderParameterBuilder model, ImageFormat imageFormat)
        {
        ...
        /// <param name="imageFormat">图像的保存格式</param>
        /// <returns></returns>
        public Stream PicCompression(Bitmap image, Size destSize, EncoderParameterBuilder model, ImageFormat imageFormat)
        {
            image = GenerateSizePic(image, destSize);
            if (model == null)
            {
        ...
        /// <param name="model">图像编码参数模型</param>
        /// <returns></returns>
        private int GetEncoderParameterModelValueNumbers(EncoderParameterBuilder model)
        {
            var result = 0;
